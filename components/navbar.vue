<template>
	<div>
		<v-toolbar app class="px-3" color="primary" dark :clipped-right="clipped" fixed>
			...
			<v-spacer></v-spacer>
			<v-btn class="hidden-md-and-down" exact flat nuxt router to="/">Log In</v-btn>
			<!-- <v-btn class="hidden-md-and-down" flat @click="logout">Log Out</v-btn> -->
		...
		<v-navigation-drawer app class="hidden-lg-and-up" :clipped="clipped" fixed right v-model="drawer">
			<v-list>
				<v-list-tile exact nuxt router to="/login">
